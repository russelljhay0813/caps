...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BWEST College — Academic & Financial Management System" },
      { name: "twitter:title", content: "BWEST College — Academic & Financial Management System" },
      { property: "og:description", content: "Secure role-based academic and financial management system for BWEST College." },
      { name: "twitter:description", content: "Secure role-based academic and financial management system for BWEST College." },
